"""
Django settings for SAAU project.
...
ALLOWED_HOSTS = [config('DIGI_IP'), 'projetofinalfabiano.netlify.app']
...
WSGI_APPLICATION = 'SAAU.wsgi.application'
...
LOGGING = {
    ...
    "loggers": {
        ...
        # Django's own logger—optional to separate
        "django": {
            "handlers": ["console"],
            "level": "INFO",
            "propagate": False,
